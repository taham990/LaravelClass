...
<!-- validation -->
<?php
$name_e = $username_e = $email_e = $password_e = $number_e = $age_e = " ";
$namei =  $usernamei = $emaili = $passwordi = $numberi = " ";
...
{
	$number_e ="شماره وارد شده صحیح نمیباشد";
	$flag = true;
}
else
	$numberi = $_POST['number'];
//agei
if(strlen($_POST['age']) < 9 or strlen($_POST['age']) > 90)
{
	$agei = $_POST['age'];
	//$age_e = "سن وارد شده صحیح نیست";
	//$flag = true;
}
else
	$agei = $_POST['age'];
...
if(isset($_POST['register']))
{
	...
	$y_age = "سال تولد شما :".$person->get_age_year($agei);
}
// check ligin
	...
	<div class="container">
		<div class="form-container" style="background-color: #f2f2f2;">
			...
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
				...
				<p style="color:red"><?php echo $number_e;?></p> <br>

				<label for="age"> سن</label>
				<input type="number" id="age" name="age" placeholder="Enter your phone age">
				<p style="color:red"><?php echo $age_e;?></p> <br>
				...
				<p><?php if(isset($y_age)){ echo $y_age;}?></p> <br>
		...
		<div class="form-container" style="background-color: #e6e6e6;">
			...
			<form action="#" method="POST">
				...
				<p style="color:red	"><?php if(isset($check_log)){echo $check_log;} ?></p> <br>
